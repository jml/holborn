...
, holborn-common-types, http-api-data, http-client
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    containers either entropy errors holborn-common-types http-api-data
    http-client http-reverse-proxy http-types jwt postgresql-simple
    process servant servant-blaze servant-docs servant-server
    shakespeare text time transformers wai
  ];
